...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "nowLocate@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "nowLocate API";

        private String description = "nowLocate API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "nowLocate";
